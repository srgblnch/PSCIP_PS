...
//+=============================================================================
//
// file :        PSI_PSCIP2Class.cpp
//
// description : C++ source for the PSI_PSCIP2Class. A singleton
//               class derived from DeviceClass. It implements the
//               command list and all properties and methods required
//               by the PSI_PSCIP2 once per process.
//
...
//+----------------------------------------------------------------------------
/**
 *	Create PSI_PSCIP2Class singleton and return it in a C function for Python usage
 */
//+----------------------------------------------------------------------------
extern "C" {
#ifdef WIN32
...
__declspec(dllexport)
	...
	Tango::DeviceClass *_create_PSI_PSCIP2_class(const char *name) {
		return PSI_PSCIP2_ns::PSI_PSCIP2Class::init(name);
	}
}
...
CORBA::Any *OnClass::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{
	...
	((static_cast<PSI_PSCIP2 *>(device))->on());
...
CORBA::Any *OffClass::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{
	...
	((static_cast<PSI_PSCIP2 *>(device))->off());
	return new CORBA::Any();
}
...
CORBA::Any *ResetClass::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{
	...
	((static_cast<PSI_PSCIP2 *>(device))->reset());
	return new CORBA::Any();
}
...
CORBA::Any *ResetInterlocksCmd::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{
	...
	((static_cast<PSI_PSCIP2 *>(device))->reset_interlocks());
	return new CORBA::Any();
}

//+----------------------------------------------------------------------------
//
// method : 		Disable_interlocksCmd::execute()
// 
// description : 	method to trigger the execution of the command.
//                PLEASE DO NOT MODIFY this method core without pogo   
//
...
//
//-----------------------------------------------------------------------------
CORBA::Any *Disable_interlocksCmd::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{

	cout2 << "Disable_interlocksCmd::execute(): arrived" << endl;

	((static_cast<PSI_PSCIP2 *>(device))->disable_interlocks());
	return new CORBA::Any();
}

//+----------------------------------------------------------------------------
//
// method : 		Enable_interlocksClass::execute()
// 
// description : 	method to trigger the execution of the command.
//                PLEASE DO NOT MODIFY this method core without pogo   
//
...
//
//-----------------------------------------------------------------------------
CORBA::Any *Enable_interlocksClass::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{

	cout2 << "Enable_interlocksClass::execute(): arrived" << endl;

	((static_cast<PSI_PSCIP2 *>(device))->enable_interlocks());
	return new CORBA::Any();
}

//+----------------------------------------------------------------------------
//
// method : 		Interlocks_statusClass::execute()
// 
// description : 	method to trigger the execution of the command.
//                PLEASE DO NOT MODIFY this method core without pogo   
//
...
//
//-----------------------------------------------------------------------------
CORBA::Any *Interlocks_statusClass::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{

	cout2 << "Interlocks_statusClass::execute(): arrived" << endl;

	return insert((static_cast<PSI_PSCIP2 *>(device))->interlocks_status());
}
...
CORBA::Any *Read_PSC_registerCmd::execute(Tango::DeviceImpl *device,const CORBA::Any &in_any)
{
	...
	return insert((static_cast<PSI_PSCIP2 *>(device))->read__psc_register(argin));
}
...
//----------------------------------------------------------------
//
PSI_PSCIP2Class *PSI_PSCIP2Class::_instance = NULL;

//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::PSI_PSCIP2Class(string &s)
// 
// description : 	constructor for the PSI_PSCIP2Class
//
// in : - s : The class name
//
//-----------------------------------------------------------------------------
PSI_PSCIP2Class::PSI_PSCIP2Class(string &s):DeviceClass(s)
{

	cout2 << "Entering PSI_PSCIP2Class constructor" << endl;
	set_default_property();
	get_class_property();
	write_class_property();
	
	cout2 << "Leaving PSI_PSCIP2Class constructor" << endl;

}
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::~PSI_PSCIP2Class()
// 
// description : 	destructor for the PSI_PSCIP2Class
//
//-----------------------------------------------------------------------------
PSI_PSCIP2Class::~PSI_PSCIP2Class()
{
	_instance = NULL;
}
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::instance
// 
...
//
//-----------------------------------------------------------------------------
PSI_PSCIP2Class *PSI_PSCIP2Class::init(const char *name)
{
	if (_instance == NULL)
	{
		try
		{
			string s(name);
			_instance = new PSI_PSCIP2Class(s);
		}
		catch (bad_alloc)
		{
			throw;
...
PSI_PSCIP2Class *PSI_PSCIP2Class::instance()
{
	if (_instance == NULL)
	{
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::command_factory
// 
// description : 	Create the command object(s) and store them in the 
//			command list
//
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::command_factory()
{
	...
	command_list.push_back(new ResetInterlocksCmd("ResetInterlocks",
		...
		"",
		Tango::OPERATOR));
	command_list.push_back(new Disable_interlocksCmd("Disable_interlocks",
		Tango::DEV_VOID, Tango::DEV_VOID,
		"",
		"",
		Tango::OPERATOR));
	command_list.push_back(new Enable_interlocksClass("Enable_interlocks",
		Tango::DEV_VOID, Tango::DEV_VOID,
		"",
		"",
		Tango::OPERATOR));
	command_list.push_back(new Interlocks_statusClass("Interlocks_status",
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::get_class_property
// 
...
//
//+----------------------------------------------------------------------------
Tango::DbDatum PSI_PSCIP2Class::get_class_property(string &prop_name)
{
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::get_default_device_property()
// 
// description : 	Return the default value for device property.
//
//-----------------------------------------------------------------------------
Tango::DbDatum PSI_PSCIP2Class::get_default_device_property(string &prop_name)
{
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::get_default_class_property()
// 
// description : 	Return the default value for class property.
//
//-----------------------------------------------------------------------------
Tango::DbDatum PSI_PSCIP2Class::get_default_class_property(string &prop_name)
{
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::device_factory
// 
...
//
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::device_factory(const Tango::DevVarStringArray *devlist_ptr)
{
	...
	for (unsigned long i=0 ; i < devlist_ptr->length() ; i++)
	{
		...
		//----------------------------------------------------
		device_list.push_back(new PSI_PSCIP2(this, (*devlist_ptr)[i]));							 
...
//+----------------------------------------------------------------------------
//	Method: PSI_PSCIP2Class::attribute_factory(vector<Tango::Attr *> &att_list)
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::attribute_factory(vector<Tango::Attr *> &att_list)
{
	//	Attribute : Imeas
	ImeasAttrib	*imeas = new ImeasAttrib();
	Tango::UserDefaultAttrProp	imeas_prop;
	imeas_prop.set_unit("A");
	imeas->set_default_properties(imeas_prop);
	att_list.push_back(imeas);
	...
	//	Attribute : Iref
	IrefAttrib	*iref = new IrefAttrib();
	att_list.push_back(iref);
...
//
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::get_class_property()
{
...
//+----------------------------------------------------------------------------
//
// method : 	PSI_PSCIP2Class::set_default_property
// 
...
//
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::set_default_property()
{
	string	prop_name;
	string	prop_desc;
	string	prop_def;
	...
	prop_name = "InterlockTemperatureBit";
	...
	prop_name = "InterlockFlowBit";
	prop_desc = "Defines which bit of the digital input register indicates flow interlock";
	prop_def  = "";
	if (prop_def.length()>0)
	{
		Tango::DbDatum	data(prop_name);
...
//+----------------------------------------------------------------------------
//
// method : 		PSI_PSCIP2Class::write_class_property
// 
// description : 	Set class description as property in database
//
//-----------------------------------------------------------------------------
void PSI_PSCIP2Class::write_class_property()
{
	...
	string	str_title("PSI PSCIP2 power supply interface");
	title << str_title;
